...
class MPageE extends React.Component {
	static propTypes = {
						...
						return (
							<div key={`pageB-${index}`} className="page-card-box">
								<div className="pagee-header">
									...
									<div className="pagee-item-btn-box">
										{index === tabList.length - 1 ? (
											<Button
												className="pagee-card-btn"
												type="primary"
...
const mapDispatch = (dispatch) => {
	return {
		setTabListData: dispatch.mPageE.setTabListData,
		updateData: dispatch.mPageE.updateData,
		getData: dispatch.mPageE.getData,
	};
};
const mapState = (state) => {
	return {
		tabList: state.mPageE.tabList,
	};
};
export default connect(mapState, mapDispatch)(MPageE);
