...
import "./index.less";
class MPageB extends React.Component {
	static propTypes = {
		...
		Modal.info({
			...
			content: (
				<div>
					<Image
						width={200}
						src="https://jd-buc-img.oss-cn-shenzhen.aliyuncs.com/mfooter.png"
					/>
				</div>
			),
		});
		...
		return (
			<div className="content-box">
				<div className="tip-header">
					<span className="tip-txet">建议：3-5个模块，每个模块2-3条</span>
						...
						return (
							<div key={`pageB-${index}`} className="page-card-box">
								...
								<div className="tip-txet">
									例如：http://m.jddianqi.cn/home 时，只需设置 ‘/home’即可
								</div>
							</div>
						);
					})}
...
const mapDispatch = (dispatch) => {
	return {
		setTabListData: dispatch.mPageB.setTabListData,
		updateData: dispatch.mPageB.updateData,
		getData: dispatch.mPageB.getData,
	};
};
const mapState = (state) => {
	return {
		tabList: state.mPageB.tabList,
	};
};
export default connect(mapState, mapDispatch)(MPageB);
