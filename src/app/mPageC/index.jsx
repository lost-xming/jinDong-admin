...
class MPageC extends React.Component {
	static propTypes = {
...
const mapDispatch = (dispatch) => {
	return {
		setTabListData: dispatch.mPageC.setTabListData,
		updateData: dispatch.mPageC.updateData,
		getData: dispatch.mPageC.getData,
	};
};
const mapState = (state) => {
	return {
		tabList: state.mPageC.tabList,
	};
};
export default connect(mapState, mapDispatch)(MPageC);
