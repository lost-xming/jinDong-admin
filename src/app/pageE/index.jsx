...
const mapDispatch = (dispatch) => {
	return {
		setTabListData: dispatch.pageE.setTabListData,
		updateData: dispatch.pageE.updateData,
		getData: dispatch.pageE.getData,
	};
};
const mapState = (state) => {
	return {
		tabList: state.pageE.tabList,
	};
};
export default connect(mapState, mapDispatch)(PageE);
