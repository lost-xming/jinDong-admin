...
class MPageD extends React.Component {
	static propTypes = {
...
const mapDispatch = (dispatch) => {
	return {
		setTabListData: dispatch.mPageD.setTabListData,
		updateData: dispatch.mPageD.updateData,
		getData: dispatch.mPageD.getData,
	};
};
const mapState = (state) => {
	return {
		tabList: state.mPageD.tabList,
	};
};
export default connect(mapState, mapDispatch)(MPageD);
